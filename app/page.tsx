    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-brand-50 p-4">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="text-center py-6">
          <h1 className="text-3xl font-bold text-foreground mb-2">Punto Ferretero</h1>
          <p className="text-foreground/80">Administra productos, clientes, proveedores y pedidos</p>
        </div>
